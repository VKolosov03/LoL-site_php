...
<html lang='en'>
    ...
    <body>
        ...
        <main>
            <div class="central">
            <h class="title_landing"><center>Tips that will improve your micro skills</center></h>
            <a href="?lol=error"><img src="./images/sumspells.png" alt="Landing" class="circle"></a>
            <a href="?lol=error" class="caption"><p class="caption_text">Summoner spells</p></a>
            <div class="arrow left">
                <div><img src="./images/control.png" alt="Landing" class="med_circle"></div>
                <div class="triangle">▲</div>
                <div class="lil_circle"></div>
            </div>
            <div class="arrow right">
                <div><img src="./images/combo.png" alt="Landing" class="med_circle right_pic"></div>
                <div class="triangle">▲</div>
                <div class="lil_circle"></div>
            </div>
        </div>
